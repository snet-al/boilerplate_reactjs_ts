...
export const PublicLayout = ({ children, ...restProps }: Props): JSX.Element => {
  return (
    <Layout style={{ minHeight: '100vh' }}>
      ...
      >
        <div style={{ minWidth: '180px', padding: 20, lineHeight: 0, fontSize: '20px', display: 'inline-block' }}>
          Scrape
        </div>
        <Search
          style={{ borderRadius: '50px', width: 700 }}
      ...
      <Footer>
        Copyright: <a href={'https://snet.al'}>snet.al</a>
      </Footer>
    </Layout>
  )
}
